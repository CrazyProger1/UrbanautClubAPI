...
class Bot(events.EventChannel, metaclass=cls_utils.SingletonMeta):
    ...
    def __init__(self):
        ...
        self.sender = cls_utils.get_class(settings.BOT.SENDER_CLASS, not settings.DEBUG, Sender)(bot=self._aiogram_bot)
        self._router = cls_utils.get_class(settings.BOT.ROUTER_CLASS, not settings.DEBUG, Router)(bot=self._aiogram_bot)
