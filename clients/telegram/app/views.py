...
class AddObjectView(BaseView):
    ...
    async def on_initialize(self, user: TelegramUser):
        self.add_async_task(self.Event.MESSAGE, self.on_message_1)
        self.add_async_task(self.Event.MESSAGE, self.on_message_2)
        self.add_async_task(self.Event.MESSAGE, self.on_message_3)
        await self.execute_async_tasks()

    async def on_message_1(self, *args, **kwargs):
        print('msg 1')
